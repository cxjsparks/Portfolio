    ...
    return (
        <div>
            <div className="about">
                ...
                <p>The clients of the firm weren't the only ones to whom I attended. Everyone I assisted was my client, whether they worked for the firm or not, and I wanted to do the best for all of them.</p>
